...
type Command struct {
	Action string `@(
		...
		"emoji_style" | "perplexity" | "perplexity_pro" | "perplexity_recent" | "perplexity_domain" | "agent" | "codereview" | "codereview_focus" | "mcp_agent" | "plug_agent"
	)`
	Arg  string `@String?`
	Arg2 string `@String?`
	Arg3 string `@String?`
